 ...
 *  HISTORY     :
 *
 * $Id: vos.h 36142 2015-03-24 08:09:20Z gweiss $
 *
...
#else
typedef int    IPT_SEM;          /* Semaphore definition */
#endif
...
{
   TCHAR mailSlotName[IPTVOS_MAX_MAILSLOT_NAME];
   HANDLE hMailSlot;       /* Mailslot handle */
   DWORD ProcID;           /* Process which created MailSlot */
#ifndef LINUX_MULTIPROC
