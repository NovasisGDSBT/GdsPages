...
#ifndef IPT_VERSION
#define IPT_VERSION     0
#endif
   
#ifndef IPT_RELEASE
#define IPT_RELEASE     0
#endif
...
DLL_DECL void IPTCom_enableFrameSizeCheck(int enable);
...
DLL_DECL int IPTCom_MPattach(void);
DLL_DECL int IPTCom_MPdetach(void);
#endif
